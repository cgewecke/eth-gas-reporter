...
/**
 * Example of a proxy resolver that can be used to resolves the contract
 * names of method calls routed through an EtherRouter style contract. Method
 * gets bound to the `this` property of eth-gas-reporter's ProxyResolver class and
 * inherits its methods (see documentation).
 *
